...
const movieListPresenter = new MovieList(siteHeaderElement, siteMainElement, siteBodyElement);

movieListPresenter.init(films, comments, filters);
...
//   rendeement(container, filmCard.getElement(), position);
//
...
//   };
//
//   filmCard.setCloseClickHandler(openPopup);
//
//   //закрытие попапа
//   const closePopup = () => {
...
// const viewFilmContent = new FilmContentView();
// renderElement(siteMainElement, viewFilmContent.getElement(), RenderPosition.AFTERBEGIN);
...
// renderElement(viewFilmContent.getElement(), filmCardContainerComponent.getElement(), RenderPosition.BEFOREEND);
