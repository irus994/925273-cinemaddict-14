...
const createStatisticTemplate = (stats) => {
  const {topGenre, watchedFilms, sumDuration} = stats;
  return `
    <ul class="statistic__text-list">
      ...
      <li class="statistic__text-item">
        ...
        <p class="statistic__item-text">${sumDuration}<span class="statistic__item-description">h</span> 22 <span class="statistic__item-description">m</span></p>
      </li>
      <li class="statistic__text-item">
