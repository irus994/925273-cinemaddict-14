...
const createSiteMenuTemplate = (filters) => {
  return `<nav class="main-navigation">
    ...
    ? `<a href="#${filter.type}" data-filter-type="${filter.type}" class="main-navigation__item ${filter.isActive ? 'main-navigation__item--active' : ''}">${filter.name}<span class="main-navigation__item-count">${filter.count}</span></a>`
